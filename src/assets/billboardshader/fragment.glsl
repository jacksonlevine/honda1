#version 450 core
in vec3 vertexColor;  // Updated to match the output from geometry shader
in vec2 TexCoord;     // Updated to match the output from geometry shader
in vec3 pos;          // Updated to match the output from geometry shader
out vec4 FragColor;
